...
class Profile(models.Model):
    ...
    pronouns = models.CharField(
        max_length=30, null=True, blank=True, default="pronouns"
    )
    ...
    tag_pairing2 = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
        related_name="pairing2",
        null=True,
        blank=True,
        default=None,
    )
...
class Edge(models.Model):
    ...
    def __str__(self):
        return (
            self.user1.username + " to " + self.user2.username + ", " + str(self.weight)
        )
